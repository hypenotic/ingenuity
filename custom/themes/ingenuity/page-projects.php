...
<?php get_header(); ?>	
	...
	?>
		...
		<div class="main-content">
			...
			/**
			* Template for Full-Width Project Panels
			* @author Emily Dela Cruz (Hypenotic)
			* @example <?php get_template_part( 'template-part-full-width-panels'); ?>
			* Dependency: custom-post-projects.php, projects.scss
			* Original Project: Ingenuity (151019)
			* 
			*/
