    ...
    head: {
        ...
        meta: [{
            ...
            },
            {
                hid: 'description',
                name: 'description',
                content: "A Design Build & General Contracting team that believes in happiness, craft, productivity, detail, and creativity in each square foot."
            },
            {
                hid: 'og:image',
                property: 'og:image',
                content: 'https://data.ingenuity.ca/custom/uploads/2018/03/ingenuity_card.jpg'
            },
            {
                hid: 'twitter:image',
            ...
            },
            {
                ...
                content: 'Ingenuity - Established This Century - Design Build General Contracting'
            },
            {
                hid: 'og:description',
        ...
        script: [{
                src: "https://maps.googleapis.com/maps/api/js?key=AIzaSyD6SyhFeGyRXakUOo6WbZsRrFMaOgaOgYM",
                body: true
            },
            {
                src: '//cdn.trackduck.com/toolbar/prod/td.js',
                "data-trackduck-id": '59930bc28fc753830a14d52d',
                async: true,
                body: true
            },
        ],
